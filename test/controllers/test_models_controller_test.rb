...
class TestModelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_model" do
    assert_difference('TestModel.count') do
      post test_models_url, params: { test_model: { thing: @test_model.thing } }
    end

    assert_redirected_to test_model_path(TestModel.last)
  end
  ...
  test "should update test_model" do
    patch test_model_url(@test_model), params: { test_model: { thing: @test_model.thing } }
    assert_redirected_to test_model_path(@test_model)
  end
